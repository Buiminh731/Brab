...
<html>
                ...
                <div class="col-lg-6 col-md-6">
                    <nav class="header__menu mobile-menu">
                        <ul>
                            ...
                            <c:if test="${c.is_driver}"><li class="active"><a href="<%=request.getContextPath()%>/drivercontrol">Order</a></li></c:if>
    ...
    <c:set var="prevent" value="${requestScope.prevent}"/>



    <div class="col-8 container login-window">
        <c:if test="${not empty prevent}">
            <p style="color: #F94D30; font-size: small;font-weight: 500">${prevent}</p>
        </c:if>
                                                                                        ...
                                                                                        <h6>Drop Location: ${b.drop_location}<h6>
                                                                                                <h6>Pick Time: ${b.pick_time}<h6>
                                                                                                        ...
                                                                                                        <form action="drivercontrol" method="post">
                                                                                                            <input type="hidden" value="${b.customer_id}" name="cid">
                                                                                                            <input type="hidden" value="${b.book_id}" name="id">
                                                                                                            <input type="hidden" value="deconfirm" name="but" >
                                                                                                            <button type="submit">Deconfirm</button>
                                                                                                        </form>
                                                                                                                                                                        ...
                                                                                                                                                                        <h6>Drop Location: ${b.drop_location}<h6>    
                                                                                                                                                                                <h6>Pick Time: ${b.pick_time}<h6>
                                                                                                                                                                                        ...
                                                                                                                                                                                        <form action="drivercontrol" method="post">
                                                                                                                                                                                            <input type="hidden" value="${b.customer_id}" name="cid">
                                                                                                                                                                                            <input type="hidden" value="${b.book_id}" name="id">
                                                                                                                                                                                            <input type="hidden" value="confirm" name="but" >
