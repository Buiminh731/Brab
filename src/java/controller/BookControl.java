 ...
 * @author Minh Bui
 */
@WebServlet(name="BookControl", urlPatterns={"/booking"})
public class BookControl extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        //get all list data for each customer
        List<Book> listB = bd.getAllInfo(c.getCustomer_id());
        ...
        request.getRequestDispatcher("book_customer.jsp").forward(request, response);
    } 
